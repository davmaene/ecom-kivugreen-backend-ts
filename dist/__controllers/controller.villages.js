...
exports.__controllerVillages = void 0;
...
exports.__controllerVillages = {
    list: (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        model_villages_1.Villages.findAndCountAll({
            where: {}
        })
            .then(({ count, rows }) => {
    ...
    listbyterritoire: (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        const { idterritoire } = req.params;
        if (!idterritoire)
            return (0, helper_responseserver_1.Responder)(res, enum_httpsstatuscode_1.HttpStatusCode.NotAcceptable, "This request must have at least ! idterritoire");
        model_villages_1.Villages.findAndCountAll({
            where: {
                idterritoire
            }
