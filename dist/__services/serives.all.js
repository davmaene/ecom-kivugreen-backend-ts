...
exports.Services = {
    ...
    loggerSystem: ({ message, title }) => {
        const fl = fs_1.default.createWriteStream('__assets/as_log/log.system.infos.ini', {
    ...
    onSendSMS: ({ to, content, is_flash }) => __awaiter(void 0, void 0, void 0, function* () {
        return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                // || API_SMS_IS_FLASH,
                const payload = {
                    'phone': (0, helper_fillphone_1.completeCodeCountryToPhoneNumber)({ phone: to }),
                    'message': content,
                ...
                (0, console_1.log)("Message was sent to ==> ", to, "Content ==> ", content, "is_flash ==> ", is_flash);
            ...
            try {
                ...
                __file.mv(uploadPath, function (err) {
                    if (err)
                        ...
                        return resolve({ code: 200, message: "File uploaded done", data: { filename, fullpath: uploadPath } });
                });
            }
            catch (error) {
