...
__routesCredits.put("/credit/changestatus/:id_credit",__controllersCredits.changestatus)
...
__routesCredits.get("/bymembercard/:id_card",__controllersCredits.listbyidcarduser)
